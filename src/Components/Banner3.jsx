...
const Banner2 = ({
  ...
  return (
    <div className='pb-5 order-2' id='1'>
        <div className='flex flex-col md:flex-row w-[75%] md:justify-around items-center justify-self-center flex-wrap'>
            <div className='w-[60%]'>
            ...
            <div className='w-[35%] oder-1' id='2'>
